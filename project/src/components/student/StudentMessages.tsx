        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100">
              Posez vos questions à vos professeurs et communiquez avec l'administration
            </p>
          </div>
                ...
                >
                  ...
                  {availableUsers.map((user) => (
                    <option key={user.id} value={user.id}>
                      {user.name} ({user.role === 'teacher' ? 'Professeur' : 'Administration'})
                    </option>
                  ))}
                </select>
              </div>
